...
def extract(context, qst, choices, ans):
    messages = [
        {"role": "system",
         "content": "You are a dataset builder tasked with providing detailed and convincing explanations for every given question-and-answer pair. The explanations should be based on your internal parametric knowledge or common sense and ignore the false context information completely."
        },
        ##
...
def create_new_dataset(data):
    ...
    for idx, row in enumerate(data):
        ...
        explanation = extract(
            context, question, formatted_choices, gold_answer)
