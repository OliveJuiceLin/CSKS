...
model = AutoModelForCausalLM.from_pretrained(model_pool[1], device_map="auto",quantization_config = quantization_config_8bit)
...
def _update_model_kwargs_for_generation(outputs,inputs):
