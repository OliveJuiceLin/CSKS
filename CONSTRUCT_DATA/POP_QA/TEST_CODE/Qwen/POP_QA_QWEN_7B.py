...
start = time.time()
model_pool = {
    "llama":['/data3/whr/wyl/Llama-3-8B-Instruct',
              '/data3/whr/wyl/Llama-3-8B-Instruct_merged_model-alpha',
              '/data3/whr/wyl/Llama-3-8B-Instruct_parametric',
              '/data3/whr/wyl/Llama-3-8B-Instruct_parametric_beta',
              '/data3/whr/wyl/Llama-3-8B-Instruct_parametric_change-mudules',
              '/data3/whr/wyl/Llama-3-8B-Instruct_merged_model-alpha-change-mudules',],
              
    "qwen":['/data3/whr/wyl/Qwen/Qwen-7B-context',
            '/data3/whr/wyl/Qwen/Qwen-7B-parametric']
    }
...
output_path = "/data3/whr/wyl/CONSTRUCT_DATA/POP_QA/TEST_RESULT/QWEN/6-result-qwen-7b-parametric.json"
data_path = '/data3/whr/wyl/CONSTRUCT_DATA/POP_QA/5-popqa-scored.json'
...
# print(f"WRONG: {WRONG}")
# with open('/data3/whr/wyl/CONSTRUCT_DATA/MUSIQUE/TEST_RESULT/final_score/sixth_result_instruct8balpha-change-mudules_musique.json','w') as f:
