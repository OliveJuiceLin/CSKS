...
PATH_TO_CONVERTED_WEIGHTS = '/data3/whr/wyl/Qwen/Qwen2.5-72B-Instruct' #'/model_path'
PATH_TO_CONVERTED_TOKENIZER = '/data3/whr/wyl/Qwen/Qwen2.5-72B-Instruct'  #'/model_path'
...
if __name__ == '__main__':
    ...
    path = '/data3/whr/wyl/CONSTRUCT_DATA/POP_QA/5-popqa-scored.json' # '/data_path'
    output_path = '/data3/whr/wyl/CONSTRUCT_DATA/POP_QA/TEST_RESULT/llama/6-result-llama-70b-coiecd-popqa.json' #'/output_path'
    id = 0
