...
model_pool = {
    ...
    "qwen":['/data3/whr/wyl/Qwen/Qwen-7B-context',
            ...
            "/data3/whr/wyl/Qwen/Qwen2.5-72B-Instruct"]
    }
...
model = AutoModelForCausalLM.from_pretrained( model_pool["qwen"][2], device_map="auto", quantization_config = quantization_config_4bit)
print(f"vocab_size: {model.model.embed_tokens.weight.size()[0]} len_tokenizer: {len(tokenizer)}")
