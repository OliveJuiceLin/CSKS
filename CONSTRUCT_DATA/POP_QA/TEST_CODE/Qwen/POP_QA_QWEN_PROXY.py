...
MODEL_POOL = {
    "base_model_name": ["/data3/whr/wyl/Qwen/Qwen2.5-72B-Instruct"],
    "expert_model_name": ["/data3/whr/wyl/Qwen/Qwen-7B-context"],
    "antiexpert_model_name": ["/data3/whr/wyl/Qwen/Qwen-7B-parametric"]
}
# 模型选择
...
output_path = f'/data3/whr/wyl/CONSTRUCT_DATA/POP_QA/TEST_RESULT/{model_choice}/6-result-{model_choice}-proxy-{alpha}-popqa.json'
...
# print(f"WRONG: {WRONG}")
# with open('/data3/whr/wyl/CONSTRUCT_DATA/MUSIQUE/TEST_RESULT/final_score/sixth_result_proxy_musique_alphaN0.5_antiexpert-change-mudule.json', 'w') as f:
