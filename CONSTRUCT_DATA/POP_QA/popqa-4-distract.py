...
def content_generation(idx, example):
    ...
    popularity = example['s_popularity']
...
def data_pipeline():
    raw_data_path = '/data3/whr/wyl/CONSTRUCT_DATA/POP_QA/popqa-3-popularity-fliter-right.json'
    with open(raw_data_path, 'r', encoding='utf-8') as f:
        dataset = json.load(f)
    new_data_path = '/data3/whr/wyl/CONSTRUCT_DATA/POP_QA/4-popqa-distracted.json'
    # new_data = []
